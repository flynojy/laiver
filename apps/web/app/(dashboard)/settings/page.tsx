        ...
        <Card className="bg-white/88">
          ...
          <CardContent className="space-y-3">
            {providers.map((provider) => (
              <div key={provider.id} className="rounded-lg border border-[color:var(--border)] bg-[var(--muted)] p-4">
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3 text-xs text-[var(--muted-foreground)]">
                    ...
                    <div>
                      ...
                      <pre className="mt-1 overflow-x-auto rounded-md bg-[var(--muted)] p-3 leading-6">
