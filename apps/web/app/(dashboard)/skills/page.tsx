  ...
  return (
    <div className="space-y-3">
      {invocations.map((item) => (
        <div key={item.invocation_id} className="rounded-lg border border-[color:var(--border)] bg-[var(--card)] p-4">
          ...
          <Card className="bg-white/88">
            ...
            <CardContent className="space-y-4">
              <input
                ...
                className="block w-full text-sm text-[var(--muted-foreground)] file:mr-4 file:rounded-md file:border-0 file:bg-[var(--muted)] file:px-4 file:py-2 file:text-sm file:font-medium"
              />
              <div className="rounded-lg border border-[color:var(--border)] bg-[var(--muted)] p-4 text-sm text-[var(--muted-foreground)]">
                ...
                <>
                  ...
                  <div className="grid gap-4 xl:grid-cols-2">
                    <div>
                      ...
                      <pre className="overflow-x-auto rounded-xl bg-[var(--muted)] p-4 text-xs leading-6">
