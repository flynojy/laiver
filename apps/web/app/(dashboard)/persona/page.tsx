            ...
            <CardContent className="space-y-4">
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div className="space-y-2">
                  ...
                  <pre className="overflow-x-auto rounded-2xl bg-[var(--surface-2)] p-4 text-xs leading-6">{savedPreview}</pre>
                </div>
                <div className="space-y-2">
                  <Label>Edited Draft Preview</Label>
                  <pre className="overflow-x-auto rounded-2xl bg-[var(--surface-2)] p-4 text-xs leading-6">{draftPreview}</pre>
                </div>
              </div>
            </CardContent>
          </Card>
